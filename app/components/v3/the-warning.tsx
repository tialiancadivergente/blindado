...
export function TheWarning() {
  return (
    <section className="flex flex-col items-center md:px-8 px-4 md:py-14 justify-start overflow-hidden z-0 bg-[#012224] bg-center bg-cover bg-no-repeat w-full h-full md:min-h-[561px] font-battambang">
      <div
        className={`lg:container text-white mx-auto md:px-16 md:py-12 pb-10 relative lg:w-[1080px] w-full border border-[#5C6063] rounded-xl shadow-xl shadow-black`}
        style={{
          background:
            "radial-gradient(73.27% 73.27% at 50% -11.48%, #223632 0%, #091418 100%)",
        }}
      >
        <h2 className="text-white text-[32px] font-bold font-battambang">
          Se isso soa familiar, eu preciso te dizer:
        </h2>
        <p className="text-[#C39B2E] text-[32px] font-bold font-battambang">
          2025 vai ser exatamente igual!
        </p>
        <div className="text-white text-[18px] font-light font-inter flex flex-col gap-3 my-3">
          <p>
        ...
        <ul className="font-semibold text-black text-[16px] flex flex-col gap-2 list-disc list-inside">
          <li className="bg-[#C39B2E] py-1 px-4">
        ...
        <div className="text-[18px] font-light font-inter flex flex-col gap-3 mt-5">
