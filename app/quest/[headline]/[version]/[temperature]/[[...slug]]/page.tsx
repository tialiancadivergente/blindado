...
export default function Quiz({ params }: { params: { form: string } }) {
  ...
  return (
    <div>
      <section
        className={`relative flex items-center justify-center overflow-hidden h-full font-battambang`}
      >
        {/* Background image with overlay */}
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-r from-[#000000] via-[#0a3a4a] to-[#000000] opacity-100"></div>
          <Image
            src="/images/bldrc/2026-Blindado-V1-TYP-Slice 01.webp"
            alt="Background Blindado"
            fill
            priority
          ...
          <div className="flex flex-col items-center justify-center text-center py-8">
            <div className="w-full max-w-4xl mx-auto">
              <div className="mb-6 md:mb-8 flex justify-center">
                <Image
                  src="/images/bldrc/2026-Blindado-Logotipo.webp"
                  ...
                  priority
                  className="object-contain select-none pointer-events-none md:max-w-[320px] max-w-[160px]"
                />
              </div>

              <h1
                className={`text-2xl md:text-5xl text-white -mt-4 mb-1 md:mb-2 text-center font-battambang`}
              >
                FALTA APENAS UM PASSO
              </h1>
              <h2
                className={`text-2xl md:text-5xl text-white mb-4 md:mb-7 text-center font-battambang`}
              >
                PARA GARANTIR SUA VAGA!
              </h2>

              <p
                className="text-white text-base mb-5 md:mb-7 text-center font-battambang"
              >
